...
set bin_dir=.\bin\
set lnk_dir=.\obj\
set defines=/DBUILD_DEBUG=1 /DEMBER_PROFILING_ENABLED=1 /DEMBER_BUILD_CONSOLE /DPLATFORM_WINDOWS=1 /DEMBER_ASSERT_ENABLED=1 /DRHI_VULKAN=1 /DRHI_VK_VALIDATIONS_ENABLED=1
